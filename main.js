...
const PROJECTS = [
    ...
    },
    {
      ...
      invoices: [
        ...
        { stage: 'Base — System Arrival (10%)', amount:  36431.03, date: '2026-07-14', net: 30, status: 'pending', notes: 'Base contract' },
    ...
    },
      {
        ...
        invoices: [
          ...
          { stage: 'Project Complete (60%)', amount: 180910.00, date: '2026-07-07', net: 30, status: 'pending', notes: '', projected: true },
        ]
      },
      {
        id: 'equipment-depot',
        ...
        invoices: [
          ...
          { stage: 'Final Shipment (10%)', amount: 4865.50, date: '2026-07-15', net: 30, status: 'pending', notes: 'Freight: $2650', projected: true },
        ]
      },
      {
        id: 'frontier-dental',
